...
If no data needs to be passed in at instantiation time, you don't need
S.__init__().
...
def _createSingletonInstance(cls, args, kwargs):
...
class Singleton(object):
    ...
    def getInstance(cls, *args, **kwargs):
        ...
        If the singleton requires args to be instantiated, include them the
        ...
        if cls._isInstantiated():
            ...
            _createSingletonInstance(cls, args, kwargs)
    ...
    def _isInstantiated(cls):
        ...
        # Don't use hasattr(cls, 'cInstance'), because that screws things up if
        # there is a singleton that extends another singleton.  hasattr looks
        # in the base class if it doesn't find in subclass.
