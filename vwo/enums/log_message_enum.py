...
class LogMessageEnum:
    ...
    class ERROR_MESSAGES:
        ...
        GET_VARIATION_NAME_API_MISSING_PARAMS = '({file}): "getVariationName" API got bad parameters. It expects campaignTestKey(String) as first and userId(String) as second argument'
