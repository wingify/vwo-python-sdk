...
class LogMessageEnum:
    ...
    class DEBUG_MESSAGES:
        ...
        LOGGING_LOGGER_INSTANCE_USED = (
            '({file}): [API_NAME] Python logging module"s logger instantiated'
        )
        SDK_INITIALIZED = "({file}): [API_NAME] SDK properly initialzed"
        SETTINGS_FILE_PROCESSED = (
            "({file}): [API_NAME] Settings file processed"
        )
        ...
        PARAMS_FOR_PUSH_CALL = (
            "({file}): [API_NAME] Params for push call - {properties}"
        )
    ...
    class ERROR_MESSAGES:
        ...
        SETTINGS_FILE_CORRUPTED = "({file}): [API_NAME] Params passed to the VWO constructor are not correct. Please refer the docs.."
        ...
        API_CONFIG_CORRUPTED = (
            "({file}): [API_NAME] API has corrupted configuration"
        )
        ...
        NO_CAMPAIGN_FOUND = "({file}): [API_NAME] No campaign found for goal_identifier:{goal_identifier}. Please verify from VWO app."
