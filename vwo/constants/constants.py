...
class CUSTOM_HEADERS:
    CUSTOM_HEADER_VISITOR_IP = "vwo_visitor_ip"
    CUSTOM_HEADER_VISITOR_USER_AGENT = "vwo_visitor_user_agent"
    ALLOWED_CUSTOM_HEADERS = [CUSTOM_HEADER_VISITOR_IP, CUSTOM_HEADER_VISITOR_USER_AGENT]
