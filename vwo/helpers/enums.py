...
class LogMessageEnum:
    ...
    class ERROR_MESSAGES:
        ...
        TRACK_API_GOAL_NOT_FOUND = '({file}): Goal:{goal_identifier} not found for campaign:{campaign_test_key} and userId:{user_id}'
        TRACK_API_REVENUE_NOT_PASSED_FOR_REVENUE_GOAL = '({file}): Revenue value should be passed for revenue goal:{goal_identifier} for campaign:{campaign_test_key} and userId:{user_id}'
