...
class GetFeatureVariableValueTest(unittest.TestCase):
    ...
    def test_get_feature_variable_value_against_FT_100_W_33_33_33_WS_WW_False(self):
        vwo_client_instance = vwo.VWO(json.dumps(SETTINGS_FILES.get('FT_100_W_33_33_33_WS_WW')),
                                      log_level=TEST_LOG_LEVEL,
                                      is_development_mode=True)
        ...
        for test in USER_EXPECTATIONS.get('AB_T_100_W_33_33_33'):
            self.assertIs(vwo_client_instance.get_feature_variable_value('FT_100_W_33_33_33_WS_WW',
                                                                         'STRING_VARIABLE',
                                                                         test['user'],
                                                                         custom_variables=false_custom_variables,
                                                                         variation_targeting_variables=false_variation_targeting_variables),  # noqa:501
                          None)
    ...
    def test_get_feature_variable_value_string_against_FT_100_W_33_33_33_WS_WW(self):
        ...
        for test in USER_EXPECTATIONS.get('AB_T_100_W_33_33_33'):
            result = vwo_client_instance.get_feature_variable_value('FT_100_W_33_33_33_WS_WW',
                                                                             'STRING_VARIABLE',
                                                                             test['user'],
                                                                             custom_variables=false_custom_variables,
