...
class CustomDimensionUtilTest(unittest.TestCase):
    ...
    def test_get_url_param_(self):
        ...
        with mock.patch('vwo.helpers.generic_util.get_random_number', return_value='123456789'),\
                mock.patch('vwo.helpers.generic_util.get_current_unix_timestamp', return_value='123456789'):
            result = custom_dimensions_util.get_url_params(self.settings_file,
                                                           'browser',
                                                           'chrome',
                                                           self.user_id,
                                                           )
            ...
            params = {
                ...
                'u': uuid_util.generator_for(self.user_id, TEST_ACCOUNT_ID),
