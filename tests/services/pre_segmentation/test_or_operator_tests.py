...
class TestOrOperatorTests(unittest.TestCase):

    def setUp(self):
        self.segment_evaluator = SegmentEvaluator()

    def test_multiple_or_operator_with_single_correct_value_test(self):
        dsl = \
    ...
    def test_single_or_operator_mismatch_test(self):
        dsl = '{"or":[{"custom_variable":{"eq":"eq_value"}}]}'
        custom_variables = {'a': 'n_eq_value'}
        self.assertIs(self.segment_evaluator.evaluate('campaing_key', 'user_id', json.loads(dsl),
                      custom_variables), False)

    def test_multiple_or_operator_test(self):
        dsl = \
    ...
    def test_multiple_or_operator_with_all_incorrect_correct_values_test(self):
        dsl = \
            '{"or":[{"or":[{"custom_variable":{"eq":"eq_value"}}]},{"or":[{"custom_variable":{"reg":"regex(myregex+)"}}]}]}'
    ...
    def test_single_or_operator_case_mismatch_test(self):
        dsl = '{"or":[{"custom_variable":{"eq":"eq_value"}}]}'
        custom_variables = {'eq': 'Eq_Value'}
        self.assertIs(self.segment_evaluator.evaluate('campaing_key', 'user_id', json.loads(dsl),
                      custom_variables), False)

    def test_multiple_or_operator_with_all_correct_values_test(self):
        dsl = \
            '{"or":[{"or":[{"custom_variable":{"eq":"eq_value"}}]},{"or":[{"custom_variable":{"reg":"regex(myregex+)"}}]}]}'
    ...
    def test_single_or_operator_matching_test(self):
        dsl = '{"or":[{"custom_variable":{"eq":"eq_value"}}]}'
        custom_variables = {'eq': 'eq_value'}
        self.assertIs(self.segment_evaluator.evaluate('campaing_key', 'user_id', json.loads(dsl),
                      custom_variables), True)

    def test_multiple_or_operator_with_single_correct_value_test2(self):
        dsl = \
            '{"or":[{"or":[{"custom_variable":{"eq":"eq_value"}}]},{"or":[{"custom_variable":{"reg":"regex(myregex+)"}}]}]}'
