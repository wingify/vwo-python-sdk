...
class TestContainsOperandTests(unittest.TestCase):
    ...
    def test_suffix_match_test(self):
        dsl = \
            '{"or":[{"custom_variable":{"eq":"wildcard(*something*)"}}]}'
        custom_variables = {'eq': 'asdn3kn42knsdsomething'}
        self.assertIs(self.segment_evaluator.evaluate('campaing_key', 'user_id', json.loads(dsl),
                      custom_variables), True)
    ...
    def test_float_data_type_test(self):
        dsl = \
            '{"or":[{"custom_variable":{"eq":"wildcard(*123.456*)"}}]}'
        custom_variables = {'eq': 765123.4567364}
        self.assertIs(self.segment_evaluator.evaluate('campaing_key', 'user_id', json.loads(dsl),
                      custom_variables), True)
    ...
    def test_contains_match_test(self):
        dsl = \
            '{"or":[{"custom_variable":{"eq":"wildcard(*something*)"}}]}'
        custom_variables = {'eq': 'asdn3kn42knsdsomethingjsbdj'}
        self.assertIs(self.segment_evaluator.evaluate('campaing_key', 'user_id', json.loads(dsl),
                      custom_variables), True)
    ...
    def test_stringified_float_test(self):
        dsl = \
            '{"or":[{"custom_variable":{"eq":"wildcard(*123.456*)"}}]}'
        custom_variables = {'eq': '87654123.4567902'}
        self.assertIs(self.segment_evaluator.evaluate('campaing_key', 'user_id', json.loads(dsl),
                      custom_variables), True)
    ...
    def test_numeric_data_type_mismatch_test2(self):
        dsl = '{"or":[{"custom_variable":{"eq":"wildcard(*123*)"}}]}'
        custom_variables = {'eq': 765123.7364}
        self.assertIs(self.segment_evaluator.evaluate('campaing_key', 'user_id', json.loads(dsl),
                      custom_variables), True)
    ...
    def test_contains_operand_falsy_test_with_special_character(self):
        dsl = \
